  ...
  useEffect(() => {
    const fetchPedido = async () => {
      try {
        ...
        const totalPedidos = response.data.tabela.map((item) =>
      ...
      <div className="px-24 py-8">
        <div className="grid grid-cols-3 gap-6">
          <div className="bg-light-green border border-gray-200 rounded-lg shadow p-4 text-center">
            <h3 className="uppercase text-xl font-semibold">Pedidos do Dia</h3>
            <p className="text-2xl font-bold">{totalPedidosDia}</p>
          </div>
          <div className="bg-light-green border border-gray-200 rounded-lg shadow p-4 text-center">
            <h3 className="uppercase text-xl font-semibold">Pedidos Totais</h3>
            <p className="text-2xl font-bold">{totalPedidosTotais}</p>
          </div>
          <div className="bg-light-green border border-gray-200 rounded-lg shadow p-4 text-center">
            <h3 className="uppercase text-xl font-semibold">
              Clientes Registrados
            </h3>
            <p className="text-2xl font-bold">{totalClientesRegistrados}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 py-8">
          ...
          <div className="bg-light-green border border-gray-200 rounded-lg shadow p-8">
            <h3 className="text-2xl font-bold mb-4">Pedidos por Status</h3>
            {isLoadingP ? (
          ...
          <div className="bg-light-green border border-gray-200 rounded-lg shadow p-8">
            <h3 className="text-2xl font-bold mb-4">Lucro do Dia</h3>
            {isLoading ? (
