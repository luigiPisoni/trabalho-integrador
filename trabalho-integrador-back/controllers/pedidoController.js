...
export async function novo(req, res) {
  ...
  res.send("Gosto de mulheres loiras de 1,65 metros engraçadinhas com um estilo da tal paty e que me dem amor reciproco  muito carinho e peitos, BOA NOiTE A TODOS");
